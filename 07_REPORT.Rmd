...
3.  Use the UN Geoscheme to define geographic regions and visually group recipes.
...
The top 25 ingredients are not very surprising and make intuitive sense. I am a little surprised that onion is first compared to salt and water. 

### Heatmap of Top 50 Ingredients

To answer what are the most common ingredients by cuisine, the following histograms graphs were created. This allows us to step through all the cuisines and take notice of which ingredients appeared the most. I organized them by the UN Geoscheme for regions and when a cuisine was not a country, I grouped it with where the cuisine is typically associated with. The only cuisine I did not do this was Jewish cuisine since they cover multiple areas and are dispersed globally. We will use these groupings for visualization later.
...
- Converted the table into a matrix and standardized values for analysis

### Principal Component Analysis (PCA)
- Ran PCA to reduce the high-dimensional ingredient matrix into 50 components
